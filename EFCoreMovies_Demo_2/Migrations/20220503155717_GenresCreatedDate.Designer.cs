...
namespace EFCoreMovies_Demo_2.Migrations
{
    ...
    [Migration("20220503155717_GenresCreatedDate")]
    partial class GenresCreatedDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreMovies_Demo_2.Entities.Cinema", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("0cbe7156-4cb8-45de-a6d1-b8748e4d114d"),
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-91.08398 30.38568)"),
                            Name = "AMC"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreMovies_Demo_2.Entities.Keyless.CinemaWithoutLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EFCoreMovies_Demo_2.Entities.Keyless.MovieWithCounts", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToSqlQuery("select * from public.movieswithcounts");
                });

            modelBuilder.Entity("EFCoreMovies_Demo_2.Entities.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
